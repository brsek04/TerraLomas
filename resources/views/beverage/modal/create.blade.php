<div id="modal-create" aria-hidden="true" class="hidden overflow-x-hidden overflow-y-auto fixed top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center h-modal sm:h-full"  tabindex="-1">
    <div class="relative w-full max-w-4xl px-4 h-full md:h-auto">
        ...
        <div class="relative flex-wrap bg-white rounded-lg shadow dark:bg-gray-700 px-5 py-4">
            ...
            <div class="col-span-6 sm:col-span-3">
                <form action="{{ route('beverages.store') }}" method="POST" enctype="multipart/form-data" class="p-2 md:p-5" id="createBeverageForm">
                    {{ csrf_field()}}
                    <div class="grid grid-cols-6 gap-6 border-b pb-6 border-gray-200 border-opacity-15">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            {!! $errors->first('description', '<div class="text-red-500 text-sm mt-1">:message</div>') !!}
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            {!! $errors->first('photo', '<div class="text-red-500 text-sm mt-1">:message</div>') !!}
                        </div>
                
                    </div>
                    <div class="flex justify-start w-full items-start p-6  rounded-b ">
