...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-4">Órdenes en cocina</h1>

    <form method="GET" action="{{ route('order.kitchen') }}" class="mb-4">
        ...
        <select name="status" id="status" class="border border-gray-300 rounded p-2">
            ...
            <option value="preparing" {{ $status == 'preparing' ? 'selected' : '' }}>En preparación</option>
        </select>
